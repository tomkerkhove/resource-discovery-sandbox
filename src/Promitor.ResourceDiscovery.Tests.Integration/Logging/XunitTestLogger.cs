...
namespace Promitor.ResourceDiscovery.Tests.Integration.Logging
{
    /// <summary>
    /// <see cref="ILogger"/> representation of a xUnit <see cref="ITestOutputHelper"/> logger.
    /// </summary>
    /// <remarks>Source: https://github.com/arcus-azure/arcus.testing/blob/master/src/Arcus.Testing.Logging/XunitTestLogger.cs (unshipped by now)</remarks>
